...
This document demonstrates migrating the existing `campaigns.router.ts` to use the `@yobo/framework` SDK.
...
## After: Using @yobo/framework SDK (8 lines per endpoint)
...
The `@yobo/framework` SDK successfully:
